...
export default async function StaffDashboardPage() {
  ...
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-muted">本日の売上状況をリアルタイムに集計</p>

      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <StatCard label="確定売上" value={formatYen(summary.confirmedSales)} />
        <StatCard label="進行中の見込み" value={formatYen(summary.pendingEstimate)} />
